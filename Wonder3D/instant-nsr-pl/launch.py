...
def main():
    ...
    # config.ckpt_dir = config.get('ckpt_dir') or os.path.join(config.exp_dir, config.trial_name, 'ckpts')
    # config.code_dir = config.get('code_dir') or os.path.join(config.exp_dir, config.trial_name, 'code')
    # config.config_dir = config.get('config_dir') or os.path.join(config.exp_dir, config.trial_name, 'configs')
    config.exp_dir = config.get('exp_dir') or os.path.join(args.exp_dir, config.name)
    config.save_dir = config.get('save_dir') or os.path.join(config.exp_dir, 'save')
    config.ckpt_dir = config.get('ckpt_dir') or os.path.join(config.exp_dir, 'ckpts')
    config.code_dir = config.get('code_dir') or os.path.join(config.exp_dir, 'code')
    config.config_dir = config.get('config_dir') or os.path.join(config.exp_dir, 'configs')
    ...
    if args.train:
        loggers += [
            TensorBoardLogger(args.runs_dir, name=config.name),
